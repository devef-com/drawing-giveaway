      ...
      >
        ...
        >
          <div className="relative group">
            <div className="absolute -inset-2 bg-linear-to-br from-indigo-500 via-purple-500 to-indigo-500 rounded-lg blur-lg opacity-60 group-hover:opacity-100 transition duration-500"></div>
          ...
          <h1 className="text-3xl font-bold bg-linear-to-br from-indigo-300 via-purple-300 to-indigo-300 text-transparent bg-clip-text">
